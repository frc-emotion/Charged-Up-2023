...
public class LevelChargeStationAuto extends SequentialCommandGroup {
    ...
    public LevelChargeStationAuto(SwerveSubsytem swerveSubsytem, ArmSubsystem aSubsystem, ElevatorSubsystem ElevatorSubsystem, ClawSubsystem ClawSubsystem, PathPlannerTrajectory path){

        addCommands(
        //     RobotContainer.autoAbstracted.placeConeMid(),
