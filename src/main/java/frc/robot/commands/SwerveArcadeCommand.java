...
public class SwerveArcadeCommand extends CommandBase {
    ...
    public SwerveArcadeCommand(SwerveSubsytem swerveSubsytem,
    ...
    public void execute() {
        ...
        // deadBand
        xSpeed = Math.abs(xSpeed) > (OIConstants.kDeadband / 4 )? xSpeed : 0.0;
        ySpeed = Math.abs(ySpeed) > (OIConstants.kDeadband / 4 )? ySpeed : 0.0;
        turningSpeed = Math.abs(turningSpeed) > ( OIConstants.kDeadband / 4) ? turningSpeed : 0.0;
