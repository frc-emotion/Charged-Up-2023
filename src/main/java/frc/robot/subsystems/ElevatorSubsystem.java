...
public class ElevatorSubsystem extends SubsystemBase{
    ...
    public ElevatorSubsystem(){
        ...
        elevatorMotor.setPeriodicFramePeriod(PeriodicFrame.kStatus2, 10);
        elevatorMotor.setCANTimeout(300);


        TrapezoidProfile.Constraints constraints = new TrapezoidProfile.Constraints(3.5, 0.8);
    ...
    public void manualMove(Supplier<Double> func, Mace mSub){
        if(getHeight() > Constants.ElevatorConstants.MINLEVEL ){
